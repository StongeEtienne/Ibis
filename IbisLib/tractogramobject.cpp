...
TractogramObject::TractogramObject()
{
    ...
    this->splineFilter = vtkSmartPointer<vtkSplineFilter>::New();
    this->splineFilter->SetSubdivideToSpecified();
    this->splineFilter->SetNumberOfSubdivisions(25);
    this->splineFilter->Update();
    this->splineFilter->SetInputConnection( m_clippingSwitch->GetOutputPort() );
